...
<div class="search-block">
	<form action="<?php echo esc_url( home_url() ); ?>" class="searchform" id="searchform" method="get" role="search">
		<div>
			...
			<?php
			$placeholder_text = '';
			if ( isset( $medical_circle_customizer_all_values['medical-circle-search-placholder'] ) ) :
				$placeholder_text = ' placeholder="' . esc_attr( $medical_circle_customizer_all_values['medical-circle-search-placholder'] ) . '" ';
			endif;
			?>
